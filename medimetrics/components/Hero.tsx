...
export function Hero() {
  ...
  useEffect(() => {
    if (posthog && (posthog as any).onFeatureFlags) {
  ...
  const onDemoClick = () => posthog.capture('cta_click', { variant, cta: 'demo' });
  const onTrialClick = () => posthog.capture('cta_click', { variant, cta: 'trial' });
